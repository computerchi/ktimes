...
/**
 * A utility class to host the jewish related calendar functions.
 * @class JewishCalindar
 */
class JewishCalindar {
  /**
   * Calculates the jewish pesach based on gregorian year.
   * @param  {number} gYear - Gregorian year
   * @return {Date} Pesach date object {year, month, day}
   * @memberof JewishCalindar
   */
  getPesachDate(gYear) {
